...
public class Main {
    public static void main(String[] args) {
        ...
        Exercicio e1 = new Exercicio(m1, 1, "Supino reto", 4, 12);
        Exercicio e2 = new Exercicio(m2, 2, "Agachamento", 4, 10);
        Exercicio e3 = new Exercicio(m3, 3, "Elevação lateral", 5, 20);
        Exercicio e4 = new Exercicio(m4, 4, "Posterior de ombro", 4, 15);
